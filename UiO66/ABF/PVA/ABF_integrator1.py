...
def main():
	...
	parser.add_argument('-p','--periodicity',nargs='*',default=[True,True,True],help='periodicity of the CVs (True is periodic, False is not)')
	...
	parser.add_argument('-c','--contours',type=int,default=5,help='number of contours on final plot')
